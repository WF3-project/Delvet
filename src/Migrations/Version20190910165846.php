 ...
 */
final class Version20190910165846 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE courses ADD description VARCHAR(255) NOT NULL, CHANGE categories_id categories_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE courses DROP description, CHANGE categories_id categories_id INT DEFAULT NULL');
