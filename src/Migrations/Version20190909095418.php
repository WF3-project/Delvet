 ...
 */
final class Version20190909095418 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE courses ADD file_name VARCHAR(255) NOT NULL, CHANGE categories_id categories_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE courses DROP file_name, CHANGE categories_id categories_id INT DEFAULT NULL');
